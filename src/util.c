 ...
 *  utill.c: support/compatibility functions for tcm portabililty
 *  actions.c: controls the dynamic action configuration of the tcm
 *
 *  Copyright (C) 2003-2004 Joshua Kwan and the Hybrid Development Team
 *
 ...
 *  USA
 *
 *    $Id: util.c,v 1.2 2004/06/10 23:20:24 bill Exp $
 */
